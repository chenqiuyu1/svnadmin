  ...
  <tr>
    ...
    <td align="center">
      <?php if (GetBoolValue("ApacheWebLink")) { ?><a href="<?php print($item->apacheWebLink); ?>" target="_blank"><img src="templates/images/apache-icon.png" alt="A" title="Apache WebDAV"></a><?php } ?>
        <?php if (GetBoolValue("JerryBranch") && $item->type == 0) { ?>
            <a href="branchcreate.php?pi=<?php print(GetValue("Repository")->getEncodedParentIdentifier()); ?>&amp;r=<?php print(GetValue("Repository")->getEncodedName()); ?>&amp;p=<?php print($item->getEncodedRelativePath()); ?>" target="_blank"><img src="templates/icons/edit_add.png"  title="Create Branch"></a><?php } ?>
